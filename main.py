...
def get_option():
    ...
    parser.add_argument('--use_admm_route_refine', type=str2bool, default=False, help='use routed-wire refinement force')
    parser.add_argument('--route_freq', type=int, default=1000, help='routing freq')
    parser.add_argument('--admm_route_freq', type=int, default=200, help='routing refresh freq for ADMM refinement')
    parser.add_argument('--admm_route_start_overflow', type=float, default=0.2, help='start ADMM refinement when overflow is below this value')
    ...
    parser.add_argument('--admm_route_weight', type=float, default=1.0, help='the weight of routed-wire refinement')
    parser.add_argument('--admm_anchor_weight', type=float, default=0.1, help='the weight of the ADMM anchor penalty')
